...
public class SimhashSimilarity {
	...
	public SimhashSimilarity(String tokens) throws IOException {
		this.tokens = tokens;
		this.intSimHash = this.simHash();
	}

	public SimhashSimilarity(String tokens, int hashbits) throws IOException {
		this.tokens = tokens;
	...
	public int hammingDistance(SimhashSimilarity other) {
	...
	public List<BigInteger> subByDistance(SimhashSimilarity simHash, int distance) {
		// 分成几组来检查
